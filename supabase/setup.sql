-- Unison database setup: paste into Supabase → SQL Editor → Run (once).
-- Generated from supabase/migrations/*.sql. All objects are prefixed unison_.
begin;
...
-- ===== 0002_campaigns_sales_results.sql =====
